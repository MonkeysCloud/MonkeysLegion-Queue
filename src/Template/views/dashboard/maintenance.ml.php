...
<div class="card" style="border-top: 4px solid var(--danger);">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2.5rem;">
        ...
        <div class="card" style="margin-bottom: 0; background-color: rgba(0,0,0,0.1); border-style: dashed;">
            ...
            <form method="post" action="{{ $dashboard_prefix }}/queue/clear" data-confirm="Are you sure you want to clear all ready jobs from this channel?" data-confirm-title="Confirm Channel Purge">
                @csrf
                ...
                <button type="submit" class="btn btn-danger mt-6 w-full" style="padding: 1rem;">Execute Purge</button>
            </form>
            </div>
        </div>
        ...
        <div class="card" style="margin-bottom: 0; background-color: rgba(244, 63, 94, 0.05); border-color: rgba(244, 63, 94, 0.2); display: flex; flex-direction: column;">
            ...
            <div style="margin-top: auto;">
                <form method="post" action="{{ $dashboard_prefix }}/queue/purge" style="width: 100%;" data-confirm="INITIATE TOTAL SYSTEM PURGE? This operation is irreversible and will delete all jobs from all channels." data-confirm-title="Total System Purge">
                    @csrf
                    <button type="submit" class="btn btn-danger w-full" style="padding: 1.25rem; background-color: var(--danger); color: white; border: none; box-shadow: 0 4px 20px rgba(244, 63, 94, 0.4);">
