...
<div class="flex justify-between items-center mb-8">
    ...
    <div class="flex gap-4">
        ...
        <form method="post" action="{{ $dashboard_prefix }}/failed/clear" onsubmit="return confirm('Purge archive?')">
            @csrf
...
<div class="card" style="border-top: 4px solid var(--danger);">
    <div class="table-container">
        <form id="bulk-actions-form" method="post" action="{{ $dashboard_prefix }}/failed/delete">
        @csrf
        <table>
            <thead>
                <tr>
